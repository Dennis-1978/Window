...
window.addEventListener('DOMContentLoaded', function () {
  'use strict'; // Объект состояния модального окна калькулятора

  var modalState = {
    form: 0,
    type: 'tree'
  };
  var deadline = '2021-10-05';
...
var changeModalState = function changeModalState(state) {
  ...
  windowWidth = document.querySelectorAll('#width'),
      // окно ввода ширины окна
  windowHeight = document.querySelectorAll('#height'),
      // окно ввода высоты окна
...
var checkNumInputs = function checkNumInputs(selector) {
  var numInputs = document.querySelectorAll(selector); // Проверка ввода пользователя
...
var forms = function forms(state) {
  ...
  var clearProperty = function clearProperty() {
...
var images = function images() {
  ...
  workSection.addEventListener('click', function (event) {
    ...
    if (target && target.matches('div.myimage_big')) {
...
var modals = function modals(state) {
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    trigger.forEach(function (item) {
      if (!item.classList.contains('glazing_price_btn') && !item.classList.contains('popup_engineer_btn')) {
        item.disabled = true;
      }
  ...
  function calcScroll() {
    ...
    var scrollWidth = div.offsetWidth - div.clientWidth; // получили ширину прокрутки
  ...
  bindModal('.phone_link', '.popup', '.popup .popup_close'); // вызов 1-го модального окна калькулятора

  bindModal('.popup_calc_btn', '.popup_calc', '.popup_calc_close'); // вызов 2-го модального окна калькулятора

  bindModal('.popup_calc_button', '.popup_calc_profile', '.popup_calc_profile_close', false); // вызов 3-го модального окна калькулятора
